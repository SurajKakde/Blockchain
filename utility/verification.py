...
class Verification:
    ...
    def valid_proof(transactions, last_hash, proof):
        ...
        # This condition is of course defined by you. You could also require 10 leading 0s - this would take
        # significantly longer (and this allows you to control the speed at which new blocks can be added)
